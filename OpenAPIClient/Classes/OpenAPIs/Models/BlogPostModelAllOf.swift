...
public struct BlogPostModelAllOf: Codable, JSONEncodable, Hashable {
    ...
    public init(title: String, subTitle: String, text: String, coverPhoto: String? = nil, location: GeoCoordinates, commentsAllowed: Bool? = nil, photos: [BlogPostPhoto]? = nil, videos: [String]? = nil) {
        self.title = title
