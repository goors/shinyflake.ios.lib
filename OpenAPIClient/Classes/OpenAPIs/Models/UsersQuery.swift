...
public struct UsersQuery: Codable, JSONEncodable, Hashable {
    ...
    public var createdTime: EntitySearchQueryAllOfCreatedTime?
    public var updatedTime: EntitySearchQueryAllOfCreatedTime?

    public init(sort: String? = nil, page: Int? = nil, pageSize: Int? = nil, maxItemCount: Int? = nil, text: String? = nil, createdTime: EntitySearchQueryAllOfCreatedTime? = nil, updatedTime: EntitySearchQueryAllOfCreatedTime? = nil) {
        self.sort = sort
        self.page = page
