//
// EntitySearchResultOfUserProfileActivity.swift
//
...
public struct EntitySearchResultOfUserProfileActivity: Codable, JSONEncodable, Hashable {
    ...
    public var items: [UserProfileActivity]?
    public var entityCounts: EntitySearchResultOfUserProfileActivityAllOfEntityCounts?

    public init(totalItemCount: Int? = nil, page: Int? = nil, pageCount: Int? = nil, accessibleTotalItemCount: Int? = nil, accessiblePageCount: Int? = nil, items: [UserProfileActivity]? = nil, entityCounts: EntitySearchResultOfUserProfileActivityAllOfEntityCounts? = nil) {
